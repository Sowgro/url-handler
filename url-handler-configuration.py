...
# NOTE: this front-end was partially generated by claude
...
{''.join(inspect.getsourcelines(_collect_apps_local)[0])}
{''.join(inspect.getsourcelines(_get_icon_name)[0])}

print(json.dumps(_collect_apps_local())) \
"""
    try:
